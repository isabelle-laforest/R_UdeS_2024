...
One way to solve this is to normalize the counts to 1, which is equivalent to showing the relative counts instead of the absolute counts. We can easily achieve this without modifying our original data:
