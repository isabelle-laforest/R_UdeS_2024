...
seq_count %>% 
  ...
  dplyr::summarise(n = n(), # count the number of samples for each
...
We want to look at how microbial families are distributed across our samples using their sequence counts. We'll start very simple, by using the sum of all samples for each Phylum.
