...
) # Notice I'm saving this plot as an object, because we will be building on it.
# Wrapping in () is equivalent to calling the pcoa_comp object afterwards.
```
...
We usually rather fill those ellipses with a colour by specifying a particular "geom" argument and a transparency level: 
